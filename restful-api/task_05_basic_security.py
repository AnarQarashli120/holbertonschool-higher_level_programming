...
Implements Basic Auth, JWT Auth, and Role-based Access Control.
"""
...
def login():
    ...
    if user and check_password_hash(user.get("password"), password):
        # Generate JWT token with user role embedded in claims (optional but good practice)
...
def admin_only():
    """
    Route protected by JWT and limited to 'admin' role.
    """
...
# Custom Error Handlers for JWT to return 401
